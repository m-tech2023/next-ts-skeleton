    ...
    onSuccess: async (tokenResponse) => {
      try {
        ...
        if (userInfo) {
          ...
          // Faça algo com os dados do usuário, como preencher o formulário de cadastro
        } else {
      ...
      <form className="p-4 " onSubmit={handleSubmit}>
        ...
        <div className="d-flex flex-column mb-3 fw-bold">
          <label htmlFor="cpfOrCnpj" style={{ color: '#37406d', fontFamily: 'Roboto, sans-serif' }}>
            {formValues.registrationType === 'Pessoa Física' ? 'CPF' : 'CNPJ'}
          </label>
          <input
            className="w-auto rounded form-control-lg"
            type={formValues.registrationType === 'Pessoa Física' ? 'text' : 'text'}
            id="cpfOrCnpj"
            name="cpfOrCnpj"
